...
class BlogPostTemplate extends React.Component {
  render() {
    ...
    const affiliateParam = 'p=DX050122090268201806'
      ...
      <Layout location={this.props.location}>
        <Helmet
          ...
          meta={[
            ...
            {
              property: 'og:url',
              content: `https://blog.linuxgeek.za.net${post.frontmatter.path}`,
            },
            {
              property: 'og:image',
              content: ogImage,
            ...
            {
              property: 'og:title',
              content: `${post.frontmatter.title} | David Bezuidehout`,
            },
            {
            ...
            {
              name: 'twitter:title',
              content: `${post.frontmatter.title} | David Bezuidenhout`,
            },
            {
                  ...
                  <a
                    href={
                      post.frontmatter.category === 'fpv'
                        ? 'https://www.youtube.com/@MrTinuva'
                        : 'https://twitter.com/tinuvaza'
                    }
                    target="_blank"
