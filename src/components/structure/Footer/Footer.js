  ...
  return (
    <StyledFooter>
      <div className="social-icons">
        ...
        <a
          href="https://twitter.com/tinuvaza"
          target="_blank"
          rel="noopener noreferrer"
          title="Twitter"
        >
      ...
      <h5>
        Copyright &copy; 2017-{new Date().getFullYear()} David Bezuidenhout.
        <br />
        {/* Dedicated to Anton{' '}
        ...
        This project is{' '}
        <a
          href="https://github.com/tinuva/blog.linuxgeek.za.net"
          target="_blank"
          rel="noopener noreferrer"
        >
